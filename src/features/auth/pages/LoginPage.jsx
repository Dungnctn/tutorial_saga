...
const schema = yup.object().shape({
    email: yup.string().email('Nhập đúng định dạng email').required('Email khong duoc bo trong'),
    password: yup.string().required('Khong duoc de trong').min(6, 'Tối thiêu 6 ký tự'),
  });
                    ...
                    <div className="mt-12">
                        <form onSubmit={handleSubmit(onLogin)}>
                            <div>
                                ...
                                <input name='email' {...register("email")} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="Dungnc@gmail.com" />
                                <span className='text-red-600 italic'>{errors?.email?.message}</span>
                            </div>
                            <div className="mt-8">
                                ...
                                <input name='password' {...register("password", { required: true, minLength: 6 } )} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  type="password" placeholder="Enter your password"/>
                                <span className='text-red-600 italic'>{errors?.password?.message}</span>
                            </div>
                            <div className="mt-10">
